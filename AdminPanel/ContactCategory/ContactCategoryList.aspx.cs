...
public partial class AdminPanel_ContactCategory_ContactCategoryList : System.Web.UI.Page
{
    ...
    private void FillGridView()
    {
        ...
        try
        {
            ...
            objComm.CommandText = "PR_ContactCategory_SelectByUserID";
            if (Session["UserID"] != null)
            {
                objComm.Parameters.AddWithValue("@UserID", Session["UserID"].ToString().Trim());
            }
    ...
    private void DeleteRecord(SqlInt32 ContactCategoryID)
    {
        ...
        try
        {
            ...
            objCom.CommandText = "PR_ContactCategory_DeleteByPK";
            //if (Session["UserID"] != null)
            //    objCom.Parameters.AddWithValue("@UserID", Session["UserID"]);
            #endregion Set Connection and Command Objects

            objCom.Parameters.AddWithValue("@ContactCategoryID", ContactCategoryID);
